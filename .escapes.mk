...
escapes.o: escapes.cpp /usr/local/include/stdc-predef.h \
 ...
 libs/include/CPPExtensions/.part/../predefs.hpp \
 libs/include/CPPExtensions/.part/../.c_extern/internal-macros.h \
 ...
 libs/include/CPPExtensions/system.hpp | libs
	$(shell test -f ./escapes.mk.2)
	$(if $(filter-out 0,$(.SHELLSTATUS)),.extra/depgen)
	$(CC) -o ./escapes.o ./escapes.cpp $(CFLAGS) $(LDFLAGS) $(LDLIBS) -I "libs/include/" -L "$$(pwd)/libs/" -Wl,-rpath,'$$ORIGIN/libs/' -Wl,-l:.shared.so
